...
The Theoretical Introduction to ExpertChoice presents two designs which are illustrated in this practical vingette.
...
fractional_factorial_3261_36 <- ExpertChoice::fractional_factorial_3261_36

# Step 4
# Confirming that this is an efficient design.
colnames(fractional_factorial_3261_36) <- colnames(ff_menu)
fractional_menu_3261_36 <- search_design(ff_menu, fractional_factorial_3261_36)

# Step 5.
# This table is reported as Table 
# Confirm that this design supports all interactions.
row1_main_effects <- fractional_factorial_efficiency(~ starter + main + dessert, fractional_menu_3261_36)
row2 <- fractional_factorial_efficiency(~ starter * main + dessert, fractional_menu_3261_36)
row3 <- fractional_factorial_efficiency(~ starter + main * dessert, fractional_menu_3261_36)
row4 <- fractional_factorial_efficiency(~ starter *dessert + main , fractional_menu_3261_36)
# row5 cannot be computed because the fractional factorial does not support this.
#row5 <- fractional_factorial_efficiency(~ starter * main * dessert, fractional_menu_3261_36)

# Two different card options
# Option 1
dce_modulo_menu <- modulo_method(
  fractional_menu_3261_36,
  list(c(1, 1, 1), c(1,3,1))
)

# Option 2.
dce_modulo_menu <- modulo_method(
  fractional_menu_3261_36,
  list(c(1, 1, 1), c(1,3,1), c(0,5,0))
)


dce_efficency_menu_example <- dce_effiency(aff_menu, dce_modulo_menu)
